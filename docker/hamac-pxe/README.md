...
Tag canonique : `registry.ocamlpro.com/hamac-pxe:0.1.0` + `latest`.
...
./build.sh registry.ocamlpro.com/hamac-pxe:dev   # tag custom
```
...
docker run --rm \
  ...
  registry.ocamlpro.com/hamac-pxe:0.1.0
```
...
docker push registry.ocamlpro.com/hamac-pxe:0.1.0
docker push registry.ocamlpro.com/hamac-pxe:latest
```
